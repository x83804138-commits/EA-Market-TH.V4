...
export default function App() {
  ...
  const handleRentPackage = (pkg: EAPackage, slipUrl?: string, tradingAccount?: string, brokerPassword?: string) => {
    requireAuth(() => {
      ...
      console.log(`[ADMIN NOTIFICATION] Sending email to x83804138@gmail.com: New EA Rental Request from ${newTransaction.userName} for ${newTransaction.packageName} awaiting confirmation.`);
  ...
  const handleLogin = (userData?: Partial<User>) => {
    ...
    if (userData && authType === 'register') {
      ...
      console.log(`[ADMIN NOTIFICATION] Sending email to x83804138@gmail.com: New User Registration - ${newUser.fullName} (${newUser.email}) awaiting approval.`);
