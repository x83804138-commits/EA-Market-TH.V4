  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (submitBtn) {
        ...
        submitBtn.textContent = 'กำลังประมวลผลวิดีโอและรูปภาพ...';
      }
      ...
      console.log(`[ADMIN NOTIFICATION] Sending email to x83804138@gmail.com: New EA Submission received for ${formData.name} from ${deviceType} device.`);
      ...
      alert('ส่งข้อมูลเรียบร้อยแล้ว! ข้อมูลของคุณได้รับการบันทึกอย่างถาวรในระบบจำลอง ทีมงานจะตรวจสอบและอนุมัติภายใน 24 ชม.');
      onBack();
    } catch (error) {
